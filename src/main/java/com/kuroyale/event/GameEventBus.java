...
public class GameEventBus {
    ...
    public void publishSpellCast(boolean isPlayer, Card spell, com.kuroyale.model.arena.GridPosition center) {
    ...
    public void publishAreaEffect(boolean isPlayerSource, com.kuroyale.model.arena.Vector2 center,
    ...
    public void publishAreaEffect(boolean isPlayerSource, com.kuroyale.model.arena.GridPosition center,
            double radius, double duration, String effectType) {
        publishAreaEffect(isPlayerSource, com.kuroyale.model.arena.Vector2.fromGridPosition(center), radius,
                duration,
                effectType);
    }
