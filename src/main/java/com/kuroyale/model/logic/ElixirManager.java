...
public class ElixirManager {
    ...
    public ElixirManager() {this.currentElixir = STARTING_ELIXIR;}

    public void setDoubleElixir(boolean active) {this.doubleElixirActive = active;}
    public boolean isDoubleElixir() {return doubleElixirActive;}
