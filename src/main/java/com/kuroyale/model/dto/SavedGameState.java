...
public class SavedGameState implements Serializable {
    ...
    public double getPlayerElixir() {
        return playerElixir;
    }

    public List<String> getPlayerDeckCards() {
        return new ArrayList<>(playerDeckCards);
    }

    public List<String> getPlayerHandCards() {
        return new ArrayList<>(playerHandCards);
    }

    public List<String> getPlayerDrawPileCards() {
        return new ArrayList<>(playerDrawPileCards);
    }

    public double getBotElixir() {
        return botElixir;
    }

    public List<String> getBotDeckCards() {
        return new ArrayList<>(botDeckCards);
    }

    public List<String> getBotHandCards() {
        return new ArrayList<>(botHandCards);
    }

    public List<String> getBotDrawPileCards() {
        return new ArrayList<>(botDrawPileCards);
    }
    ...
    public List<SavedTower> getTowers() {
        return new ArrayList<>(towers);
    }

    public List<SavedTroop> getActiveTroops() {
        return new ArrayList<>(activeTroops);
    }
